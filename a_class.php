...
<head>
<title> Μαθηματικά Α' Γυμνασίου</title>
</head>
...
<table  align="center" border="10" width="800" height="800"  cellpadding="5" cellspacing="5" bgcolor="#CCFF33">
	...
	<tr align="center">
		...
		<img src="../buttons/proodos_1.bmp" onmouseover="this.src='../buttons/proodos_2.bmp'" onmouseout="this.src='../buttons/proodos_1.bmp'"  onclick="location.href='a/a_proodos.php'" width="160" height="45">&nbsp;&nbsp;&nbsp;
		<img src="../buttons/apories_1.bmp" onmouseover="this.src='../buttons/apories_2.bmp'" onmouseout="this.src='../buttons/apories_1.bmp'"  onclick="location.href='a/a_apories.php'" width="160" height="45">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<img src="../buttons/libr_1.bmp" onmouseover="this.src='../buttons/libr_2.bmp'" onmouseout="this.src='../buttons/libr_1.bmp'" onclick="location.href='a/a_libr.php'" width="160" height="45">&nbsp;&nbsp;&nbsp;
		</td>
	</tr>
	...
	<tr>	
		<td  width="200" align="center" style="border-top:3px double #003300; border-left: none; border-right: none; border-bottom: none; border-top:none" valign="center">
			...
			<a href="a_rename.php"><b>θέλω να αλλάξω <br> τα στοιχεία μου</b></a><br><br><br>
			
			<align="center" style="border-left: none; border-right: none; border-bottom: none; border-top:none" height="100" valign="top">	
			<img src="../buttons/help_1.bmp" onmouseover="this.src='../buttons/help_2.bmp'" onmouseout="this.src='../buttons/help_1.bmp'"  onclick="location.href='../a/a_help.php'" width="100" height="100">
			<br>
			
			<a href="../a/a_help.php"><b>Βοήθεια</b></a><br><br><br>	
		...
		<td align="center" style="border-right: none; border-bottom: none; border-top:none" valign="top">
			...
			<h4>ΚΕΦΑΛΑΙΟ 1ο </h4>
			<a href="../a/a_kef_1.php"><h4> Οι φυσικοί αριθμοί</h4></a></p>
			
			<h4>ΚΕΦΑΛΑΙΟ 2ο </h4>
			<a href="../a/a_kef_2.php">Τα κλάσματα</a>
			
			<h4>ΚΕΦΑΛΑΙΟ 3ο</h4>
			<a href="../a/a_kef_3.php">Δεκαδικοί αριθμοί</a>
			
			<h4>ΚΕΦΑΛΑΙΟ 4ο</h4>
			<a href="../a/a_kef_4.php">Εξισώσεις</a>
			
			<h4>ΚΕΦΑΛΑΙΟ 5ο</h4>
			<a href="../a/a_kef_5.php">Θετικοί και αρνητικοί αριθμοί</a>	<br>
			<br><br>
		</td>
	</tr>
